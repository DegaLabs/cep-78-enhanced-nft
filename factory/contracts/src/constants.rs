...
pub const NFT_FACTORY_CONTRACT_KEY_NAME: &str = "csp_factory_contract";
...
pub const ARG_REQUEST_EVOLVING_ID: &str = "request_evolving_id";
...
pub const ARG_WRAPPED_TOKEN: &str = "wrapped_token";
pub const ARG_IS_WRAPPED_TOKEN: &str = "is_wrapped_token";
pub const ARG_TOKEN_ADDRESS: &str = "token_address";
pub const ARG_ADDRESSES_WHITELIST: &str = "addresses_whitelist";

pub const REQUEST_INDEX: &str = "request_index";
pub const REQUEST_IDS: &str = "request_ids";
pub const REQUEST_EVOLVING_IDS: &str = "request_evolving_ids";
pub const REQUEST_EVOLVING_INDEX: &str = "request_evolving_index";
...
pub const ADDRESSES_WHITELIST: &str = "addresses_whitelist";
...
pub const SET_ADDRESSES_WHITELIST: &str = "set_addresses_whitelist";
pub const UPDATE_ADDRESSES_WHITELIST: &str = "update_addresses_whitelist";
pub const ARG_NEW_ADDRESSES_WHITELIST: &str = "new_addresses_whitelist";
pub const ARG_IS_WHITELISTED: &str = "is_whitelisted";
pub const ARG_NFT_OWNER: &str = "nft_owner";
pub const ARG_NFT_CONTRACT_PACKAGE: &str = "nft_contract_package";
pub const ARG_NUMBER_OF_TICKETS: &str = "number_of_tickets";
pub const ARG_IS_WHITELIST: &str = "is_whitelist";
pub const NFT_MINTED_NUMBER: &str = "nft_minted_number";
pub const NFT_MINTED_NUMBER_R3: &str = "nft_minted_number_r3";
pub const CONTRACT_PURSE: &str = "contract_purse";
pub const ARG_MINT_FEE: &str = "mint_fee";
pub const ARG_MINT_FEE_R3: &str = "mint_fee_r3";
pub const MINT_FEE: &str = "mint_fee";
pub const MINT_FEE_R3: &str = "mint_fee_r3";
...
pub const ARG_FEE_RECEIVER: &str = "fee_receiver";
