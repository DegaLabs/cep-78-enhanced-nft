...
`;
  ...
  const hash1 = "be170557d9100704b63dc5de6039373dfdc8649cc467bf2f74ea14812d233def" // CSP hash
  //=== token_owner: Key ===
  // const hexString =
  ...
  const factoryHash = "60cd90c9196ee34f44bb9faff9d7dce0563368b37637afbcc82279f3c1ec8046" // factory hash
  nftContractHash = new CLByteArray(
    Uint8Array.from(Buffer.from(factoryHash, "hex"))
  );
  let factory = createRecipientAddress(nftContractHash)
  ...
  let deploy = DeployUtil.makeDeploy(
    ...
    DeployUtil.ExecutableDeployItem.newStoredContractByHash(
      ...
      "change_minter",
      RuntimeArgs.fromMap({
        "new_minter": factory, // token address
      })
    ),
    // DeployUtil.ExecutableDeployItem.newStoredContractByHash(
    //   Uint8Array.from(Buffer.from(hash1, 'hex')), // DTO CASPER BRIDGE contract
