...
let paymentAmount = '100000000000' //3
...
const test = async () => {
  ...
  let boxHash = "0ffafe103b0dbf8fe66d7689a0fd70d49b742f943fa29a28eb08299af63ee912"
  // 6517e4d1101c970086603c5641a4c38248c33780a5dd522364052ad6d8cab8ec
  // marketHash = marketHash.startsWith("hash-")
  //   ? marketHash.slice(5)
  //   : marketHash;
  boxHash = new CLByteArray(
    Uint8Array.from(Buffer.from(boxHash, "hex"))
  );
  ...
  let runtimeArgs = RuntimeArgs.fromMap({
    ...
    "amount": CLValueBuilder.u512("50000000000"), // 8 cspr
    "box_contract_hash": boxKey,
    "count": CLValueBuilder.u64(5),
